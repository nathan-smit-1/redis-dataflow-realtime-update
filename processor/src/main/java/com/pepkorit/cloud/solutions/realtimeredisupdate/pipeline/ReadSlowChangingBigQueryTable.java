...
public class ReadSlowChangingBigQueryTable extends PTransform<PCollection<Long>, PCollection<KV<String, String>>> {
    private static final Logger LOG = LoggerFactory.getLogger(ReadSlowChangingBigQueryTable.class);
    private final String query;
    private final String key;
    private final String value;

    ReadSlowChangingBigQueryTable(@Nullable String name, String query, String key, String value) {
        super(name);
        this.query = query;
        this.key   = key;
        this.value = value;
